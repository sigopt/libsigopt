...
def form_multimetric_info_from_phase(phase, phase_kwargs):
  ...
  if phase == NOT_MULTIMETRIC:
    ...
    initialization_phase = secrets.SystemRandom().choice((OPTIMIZING_ONE_METRIC_OPTIMIZE_0, OPTIMIZING_ONE_METRIC_OPTIMIZE_1))
    ...
    completion_phase = secrets.SystemRandom().choice((EPSILON_CONSTRAINT_OPTIMIZE_0, EPSILON_CONSTRAINT_OPTIMIZE_1))
